...
CREATE UNIQUE INDEX IF NOT EXISTS DIRECTORS_PK_IDX
    ON PUBLIC.DIRECTORS (DIRECTOR_ID);
...
CREATE INDEX IF NOT EXISTS FILM_DIRECTORS_FILM_IDX
    ON PUBLIC.FILM_DIRECTORS (FILM_ID);

CREATE INDEX IF NOT EXISTS FILM_DIRECTORS_DIRECTOR_IDX
    ON PUBLIC.FILM_DIRECTORS (DIRECTOR_ID);
...
-- FILM_DIRECTORS -> FILMS
ALTER TABLE PUBLIC.FILM_DIRECTORS
DROP CONSTRAINT IF EXISTS FILM_DIRECTORS_FILM_FK;

ALTER TABLE PUBLIC.FILM_DIRECTORS
ADD CONSTRAINT FILM_DIRECTORS_FILM_FK
FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS(FILM_ID)
ON DELETE CASCADE;

-- FILM_DIRECTORS -> DIRECTORS
ALTER TABLE PUBLIC.FILM_DIRECTORS
DROP CONSTRAINT IF EXISTS FILM_DIRECTORS_DIRECTOR_FK;

ALTER TABLE PUBLIC.FILM_DIRECTORS
ADD CONSTRAINT FILM_DIRECTORS_DIRECTOR_FK
